            ...
            <div className="collab_container">
                ...
                <div className="content1">
                    ...
                    <div className="collab_events">
                        <div className="event_card"><img src={travis} alt="travis" /></div>
                        <div className="event_card"><img src={rocky} alt="rocky" /></div>
                        <div className="event_card"><img src={travis} alt="travis" /></div>
                        <div className="event_card"><img src={rocky} alt="rocky" /></div>
                        <div className="event_card"><img src={travis} alt="travis" /></div>
                        <div className="event_card"><img src={rocky} alt="rocky" /></div>
                        ...
                        <div className="event_card"><img src={rocky} alt="rocky" /></div>
                        <div className="event_card"><img src={travis} alt="travis" /></div>
                        <div className="event_card"><img src={rocky} alt="rocky" /></div> <div className="event_card"><img src={rocky} alt="rocky" /></div>
                        <div className="event_card"><img src={travis} alt="travis" /></div>
                        <div className="event_card"><img src={rocky} alt="rocky" /></div>
                        <div className="event_card"><img src={travis} alt="travis" /></div>
                        <div className="event_card"><img src={rocky} alt="rocky" /></div>
                ...
                <div className="content1">
                    ...
                    <div className="collab_events">
                        <div className="event_card"><img src={paris} alt="travis" /></div>
                        <div className="event_card"><img src={london} alt="rocky" /></div>
                        <div className="event_card"><img src={newyork} alt="travis" /></div>
                        <div className="event_card"><img src={italy} alt="rocky" /></div>
                        <div className="event_card"><img src={vegas} alt="travis" /></div>
                        <div className="event_card"><img src={chicago} alt="rocky" /></div>
                        <div className="event_card"><img src={paris} alt="travis" /></div>
                        <div className="event_card"><img src={london} alt="rocky" /></div>
                        <div className="event_card"><img src={newyork} alt="travis" /></div>
                        <div className="event_card"><img src={italy} alt="rocky" /></div>
